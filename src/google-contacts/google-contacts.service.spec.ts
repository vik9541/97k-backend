...
describe('GoogleContactsService', () => {
  ...
  describe('syncContacts', () => {
    it('should create new contacts on first sync', async () => {
      ...
      jest.spyOn(prisma.googleContactsSync, 'findUnique').mockResolvedValue(null);
      jest.spyOn(prisma.googleContactsSync, 'create').mockResolvedValue({
        id: BigInt(1),
        userId,
        lastSyncAt: new Date(),
        syncToken: 'token123',
      ...
      jest.spyOn(prisma.googleContactsSync, 'update').mockResolvedValue({} as any);
    ...
    it('should detect and log conflicts', async () => {
      ...
      jest.spyOn(prisma.googleContactsSync, 'findUnique').mockResolvedValue({
        id: BigInt(1),
        userId,
        lastSyncAt: new Date(),
        syncToken: 'token123',
  ...
  describe('getSyncStatus', () => {
    it('should return sync status for connected user', async () => {
      ...
      jest.spyOn(prisma.googleContactsSync, 'findUnique').mockResolvedValue(mockSync as any);
